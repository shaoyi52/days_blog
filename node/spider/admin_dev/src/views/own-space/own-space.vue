                ...
                >
                    ...
                    <FormItem label="用户手机：" prop="cellphone" >
                        <div style="display:inline-block;width:204px;">
                            <Input v-model="userForm.cellphone" @on-keydown="hasChangePhone" disabled></Input>
                        </div>
                        <div style="display:inline-block;position:relative;">
                            ...
                            <div class="own-space-input-identifycode-con" v-if="inputCodeVisible">
                                <div style="background-color:white;z-index:110;margin:10px;">
                                    <Input v-model="securityCode" placeholder="请填写短信验证码，默认654321"  @keyup.native.13="submitCode"></Input>
                    ...
                    <!--</FormItem>-->
                    <FormItem label="登录密码：">
                        <Button type="text" size="small" @click="showEditPassword" :disabled="isSave">修改密码</Button>
                    </FormItem>
                    <div>
                        <Button type="text" style="width: 100px;" @click="cancelEditUserInfor">取消</Button>
                        <Button type="primary" style="width: 100px;" :loading="save_loading" :disabled="isSave" @click="saveEdit">保存</Button>
                    </div>
                </Form>
            </div>
        </Card>
        <edit-passWword :edit-password-modal="editPasswordModal"></edit-passWword>
    </div>
</template>

<script>
import Cookies from 'js-cookie';
import editPassWword from 'modal/editPassword.vue';
export default {
    name: 'ownspace_index',
    data () {
    ...
    methods: {
        ...
        showEditPassword () {
            this.editPasswordModal.editPasswordModal = true;
        },
        cancelEditUserInfor () {
        ...
        init () {
            ...
            this.userForm.cellphone = user.mobile;
            this.initPhone = user.mobile;
        ...
        submitCode () {
            ...
            } else if(this.securityCode == '654321') {
                setTimeout(() => {
