...
/////////////////
export interface ITextDefaultType {
    key:string;
    name:string;
    type:'TextArea';
};
...
export type TMutiTextDefaultType = Array<IMutiTextConfigType>;
...
/////////////////////////
export interface ICardPickerCofigType<T>{
    key:string;
    name:string;
    type:'CardPicker';
    icons:Array<T>;
...
export type TTableDefaultConfigType=Array<{
    name:string;
    value:number;
}>
